...
export default function LandingPage() {
  ...
  return (
    <main
      ...
      style={{ backgroundImage: "url('/Background 6.25.png')" }}
    >
      <div className="max-w-5xl w-full border border-black bg-blue-50 bg-opacity-90 rounded-lg shadow-2xl flex flex-col md:flex-row overflow-hidden">
        ...
        >
          ...
          <div className="mt-80 md:mt-0">
            <h1 className="text-4xl font-bold text-gray-900 mb-4 leading-tight bg-white/60 backdrop-blur-sm p-2 rounded md:bg-transparent md:backdrop-blur-0">
              Hi, I’m Carly—I’ll help you find the best cash offer for your car
            </h1>
            <p className="text-gray-800 mb-6 text-med bg-white/60 backdrop-blur-sm p-2 rounded md:bg-transparent md:backdrop-blur-0">
