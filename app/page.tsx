...
export default function LandingPage() {
  ...
  return (
    <main
className="relative min-h-screen overflow-x-hidden bg-cover bg-bottom bg-no-repeat bg-fixed flex flex-col md:flex-row items-start justify-center px-4 py-6 md:py-24"
    ...
    >
      <div className="relative w-full max-w-3xl overflow-visible">
        ...
        <Image
          ...
          width={220}
          height={220}
          className="absolute -top-24 -right-6 md:-top-32 md:-right-20 z-10 object-contain animate-fade-bounce-once"
          priority
        />
          ...
          <div className="relative z-10">
            ...
            >
              <input
                ...
                required
className="w-full p-3 text-sm text-gray-900 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              <input
                type="email"
                name="email"
