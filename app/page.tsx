...
export default function LandingPage() {
  ...
  return (
    <main
className="relative min-h-screen overflow-x-hidden bg-cover bg-bottom bg-no-repeat bg-fixed flex flex-col md:flex-row items-start justify-center px-4 py-6 md:pb-24"
    ...
    >
      <div className="relative w-full max-w-3xl overflow-visible">
        ...
        <Image
          ...
          width={220}
          height={220}
className="absolute z-10 object-contain animate-fade-bounce-once -top-20 -right-6 md:-top-12 md:-right-6"
          priority
        />
