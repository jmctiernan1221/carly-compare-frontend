    ...
    {showMore ? 'Show Less' : 'Read More'}
            ...
            >
              <input
                ...
                required
className="w-full p-2.5 text-base text-gray-700 bg-white/40 border border-gray-300 rounded placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              <input
                type="email"
                name="email"
